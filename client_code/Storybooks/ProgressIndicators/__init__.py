...
class ProgressIndicators(ProgressIndicatorsTemplate):
  ...
  def button_1_click(self, **event_args):
    ...
    self.linear_progress_indicator_1.progress = 0
  ...
  def change_progress(self):
    ...
    while time.time() < end_time and self.circular_progress_indicator_1_copy_1.progress <= 100:
        self.circular_progress_indicator_1_copy_1.progress += 10
        self.linear_progress_indicator_1.progress += 10
