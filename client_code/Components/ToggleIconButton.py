...
selected_border_property = {"name": "selected_border", "type": "string", "group": "Selected Style", "description": "Border style when component is in the selected state. Accepts any valid CSS border value."}
