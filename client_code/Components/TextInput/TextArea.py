...
selected_property = {"name": "max_height", "type": "string", "group": "Interaction", "important": True, "default_value": False, "description": "True if button is in the toggled on state"}
