...
from ...Functions import enabled_property, style_property, underline_property, italic_property, bold_property, font_size_property, color_property, theme_color_to_css, innerText_property, margin_property, font_family_property, border_property
...
class Checkbox(CheckboxTemplate):
  ...
  background = color_property('anvil-m3-checkbox-container', 'backgroundColor', 'background')
