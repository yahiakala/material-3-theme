...
class Divider(DividerTemplate):
  ...
  #!componentProp(material_3.Divider)!1: {name:"type",type:"enum",options:["Full width", "Inset"],description:"Display the Divider across the full width of the container or inset."}
