...
class TextBox(TextInput):
  ...
  #!componentProp(material_3.TextBox)!1: {name:"description",type:"string",description:"The supporting text displayed below this component"}
  #!componentProp(material_3.TextBox)!1: {name:"description_color",type:"color",description:"The colour of the supporting text below this component."}
  #!componentProp(material_3.TextBox)!1: {name:"description_font_family",type:"color",description:"The font family to use for the supporting text below this component."}
  #!componentProp(material_3.TextBox)!1: {name:"description_font_size",type:"color",description:"The font size of the supporting text displayed below this component."}
